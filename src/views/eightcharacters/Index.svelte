                ...
                <tbody>
                    <tr class="tian-tr">
                        ...
                        <td style="color:{color_t_arr[d.char8.year.stem.toString()]}">
                            <i>{gxarr[d.char8.year.stem.toString()]}</i>{d.char8.year.stem.toString()}
                        </td>
                        <td style="color:{color_t_arr[d.char8.month.stem.toString()]}">
                            <i>{gxarr[d.char8.month.stem.toString()]}</i>{d.char8.month.stem.toString()}
                        </td>
                        ...
                        <td style="color:{color_t_arr[d.char8.hour.stem.toString()]}">
                            <i>{gxarr[d.char8.hour.stem.toString()]}</i>{d.char8.hour.stem.toString()}
                        </td>
                    </tr>
                    <tr>
                        <td>地支</td>
